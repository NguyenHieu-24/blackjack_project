...
public class GameComponent extends JComponent implements MouseListener {
    ...
    public void paint(Graphics g) {
        ...
        try{
            backgroundImage = ImageIO.read(new File("images/background_1.png"));
            board = ImageIO.read(new File("images/board_.png"));
            chip = ImageIO.read(new File("images/chip.png"));
            backsideOfACard = ImageIO.read(new File("images/backside_card.png"));
