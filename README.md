...
java -cp out Tester
```
Skip `mkdir out` if the folder already exists. Run from `OOP-Project-main` so relative asset paths resolve correctly.
<details>
<summary><strong>Using Visual Studio Code</strong></summary>
Open `OOP-Project-main` as the workspace folder.
Open the integrated terminal.
Run the compile and launch commands above.
If using an IDE launch configuration, use `Tester` as the main class and `OOP-Project-main` as the working directory.
</details>
<details>
...
![Starting-balance entry screen](OOP-Project-main/images/img.png)
</details>
Architecture
...
Project Files
Path	Contents
`OOP-Project-main/src/`	Seven Java source files
`OOP-Project-main/images/`	Card graphics, interface assets, and screenshots
`OOP-Project-main/sounds/`	Music and sound effects
`OOP-Project-main/BLACKJACK-PROJECT.pdf`	Project report
Known Issues
...
---
<p align="center"><a href="#blackjack--xì-dách">Back to top ↑</a></p>
